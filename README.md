...
<img src="https://git.takina.io/gtfo/BashTerm/-/raw/main/.assets/icon.png?ref_type=heads" width="200" alt="Bsh Icon">
...
3. Create your own `.bshrc` config file to customize Bsh to your liking
4. Create your own Bsh extensions using the [Bsh API]()
...
For details on everything in Bsh, check out the [Docs]().